...
string my_direction("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/modelo15/");
...
double valor_octree = 0.0923735; //11
...
int main(int argc, char** argv){
  ...
  while (continuar){
    ...
    //leer nube acumulada
    nube = direccion_nube_backg + pose_.str() + ".xyz";
    pose_nube = direccion_posicion + pose_.str() + ".dat";

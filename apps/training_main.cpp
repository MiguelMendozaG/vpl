...
void filtro_voxeles(){
  ...
  string data_nubes_denso ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_nbv_aux.xyz");
  string data_nubes_denso_salida ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_nbv_aux_salida.xyz");
  string pos_nube;
  ...
  cabecera.open ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/datos_cabecera.xyz");
  cabecera << info_total;
  cabecera.close();
  //abre archivos datos_cabecera.xyz y nube_nbv_aux.xyz y los junta en un solo archivo
  std::ifstream cabecera_comb ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/datos_cabecera.xyz");  
  std::ifstream coord_comb ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_nbv_aux.xyz");
  std::ofstream combinado_filro_voxeles ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_densa_pcl.xyz");
  ...
  reader_pcl.read ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_densa_pcl.xyz", *cloud); // Remember to download the file first!
  ...
  writer.write ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_escasa_pcl.xyz", *cloud_filtered, Eigen::Vector4f::Zero (), Eigen::Quaternionf::Identity (), false);
  ////////////////////
  /*
  string deleteline(info_total);
  string line;

  ifstream infile;
  infile.open("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_escasa_pcl.xyz");
  ofstream temp;
  temp.open("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_escasa_pcl_sin_cabecera.xyz");
  */
  std::string ID;
  int cuenta =0;
  ID = "WIDTH "; //id of the line we want to delete
    //ifstream read("infos.txt");
    ifstream read_f("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_escasa_pcl.xyz");
    //ofstream write("tmp.txt"); 
    ofstream write("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_escasa_pcl_sin_cabecera.xyz");
    if (read_f.is_open()) {
       std::string line;
...
int main(int argc, char **argv) {
  ...
  string direccion_nube_filtrada("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_escasa_pcl_sin_cabecera.xyz");
  ...
  string data_octomap_acum("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/octomap_acumulado/octomap_");
  ...
  string data_nubes("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nubes/nube_nbv");
  string data_nubes_denso ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/6d pose/hinterstoisser/nubes/nbv_i/nube_model_denso/nube_nbv_aux");
  ...
  while (cov_t < 90){
    ...
    partial_model->updateWithScan(pos_actual_nubes, pos_actual_aux);
    pos_actual = data_octomap_acum + tt.str() + ext_oct;
    partial_model->savePartialModel(pos_actual);
    ...
    for (int j = 0; j<1312; j++){
      std::stringstream jj;
      jj << j;
      cout << "\n\t\t\t Planificación # " << t <<" Comparando imagen #" << j << endl;
      ...
      if (traslape >= 50)
      { 
	cout << "\n\t\t\t Planificación # " << t <<" Traslape > 50% #" << j << endl;

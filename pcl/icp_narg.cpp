...
main (int argc, char** argv)
{
  ...
  std::string file_cloud2("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/pcl test/nubes/imagen-635.pcd");
  NARF2 = narf_points(file_cloud2);
  
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud1 (new pcl::PointCloud<pcl::PointXYZ>);
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud2 (new pcl::PointCloud<pcl::PointXYZ>);
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud2_new (new pcl::PointCloud<pcl::PointXYZ>);
  
  pcl::io::loadPCDFile(file_cloud, *cloud1);
  pcl::io::loadPCDFile(file_cloud2, *cloud2);
  
  //cout << "nube 1 " << cloud1->points[0].x << endl;
  
  pcl::IterativeClosestPoint<pcl::PointXYZ, pcl::PointXYZ> icp;
  pcl::PointCloud<pcl::PointXYZ> finalCloud ;
  pcl::PointCloud<pcl::PointXYZ> finalCloud1 ;
 ...
 icp.setMaximumIterations (500);
  ...
  icp.setRANSACOutlierRejectionThreshold (0.00001);
  pcl::PointCloud<pcl::PointXYZ> Final;
  icp.align(Final);
  if (icp.hasConverged()){
  std::cout << "has converged:" << icp.hasConverged() << " score: " <<
  icp.getFitnessScore() << std::endl;
  Eigen::Matrix4f transformMatrix = icp.getFinalTransformation();
  std::cout << transformMatrix << std::endl;
  
  pcl::io::savePCDFile("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/pcl test/nubes/output_converged_points.pcd",Final,false);
  
  pcl::transformPointCloud(*cloud2,*cloud2_new,transformMatrix);
  pcl::io::savePCDFileASCII ("/home/miguelmg/Documents/CIDETEC/semestre 2/vision 3d/proyecto/pcl test/nubes/IcpResult.pcd", Final);
  
  finalCloud1=*cloud1;
  finalCloud1+=*cloud2_new;
  
  //cout << "final " << finalCloud1.points[0].x << endl;
  
  boost::shared_ptr<pcl::visualization::PCLVisualizer> viewer (new pcl::visualization::PCLVisualizer("3D Viewer"));
  viewer->setBackgroundColor(250,250,250);
  pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color1 (cloud1, 0, 0, 10);
  pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> single_color2 (cloud2_new, 100, 0, 0);
  
  viewer->addPointCloud<pcl::PointXYZ> (cloud1,single_color1, "sample_cloud_1");
  viewer->addPointCloud<pcl::PointXYZ> (cloud2_new, single_color2, "sample_cloud_2");
  ...
  /*
  std::string pcd_filename_indices = file_cloud;
  if (!pcd_filename_indices.empty ())
  {
    std::string filename = pcd_filename_indices;
    if (pcl::io::loadPCDFile (filename, point_cloud) == -1)
